"""
Pydantic models matching the frontend's "Analyse with AI" JSON payload.
FastAPI will use these to validate incoming requests automatically —
if a required field is missing or has the wrong type, the request is
rejected with a clear error before it ever reaches your pipeline logic.
"""
...
class Employer(BaseModel):
    ...
    # Free-text clauses the user typed manually — this is the field the
    # RAG/Gemini step needs to handle, since it can't be checked by a
    # deterministic rule.
